namespace Marketplace.Domain.Modules.Orders;

/// <summary>
/// Assembly/namespace anchor for the Orders module. No business entities yet — this Sprint
/// (1.1 Backend Foundation) only wires up cross-cutting infrastructure. Entities, value
/// objects and domain services for Orders are added when its first feature Sprint starts.
