namespace Marketplace.Domain.Modules.Catalog;

/// <summary>
/// Assembly/namespace anchor for the Catalog module. No business entities yet — this Sprint
/// (1.1 Backend Foundation) only wires up cross-cutting infrastructure. Entities, value
/// objects and domain services for Catalog are added when its first feature Sprint starts.
