namespace Marketplace.Domain.Modules.Inventory;

/// <summary>
/// Assembly/namespace anchor for the Inventory module. No business entities yet — this Sprint
/// (1.1 Backend Foundation) only wires up cross-cutting infrastructure. Entities, value
/// objects and domain services for Inventory are added when its first feature Sprint starts.
