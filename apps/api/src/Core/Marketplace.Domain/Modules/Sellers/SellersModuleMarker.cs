namespace Marketplace.Domain.Modules.Sellers;

/// <summary>
/// Assembly/namespace anchor for the Sellers module. No business entities yet — this Sprint
/// (1.1 Backend Foundation) only wires up cross-cutting infrastructure. Entities, value
/// objects and domain services for Sellers are added when its first feature Sprint starts.
